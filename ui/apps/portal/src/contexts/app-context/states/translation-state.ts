export const i18nDefault = {
  default: {
    ...
    CLEANUP_STRATEGUS_STUDY_DIALOG__CHOOSE_DATASET: "Choose a dataset",
    CLEANUP_STRATEGUS_STUDY_DIALOG__ERROR_CLEANUP_STUDY: 'Failed to cleanup study "{0}"',
    CLEANUP_STRATEGUS_STUDY_DIALOG__SELECT_DATASET: "Select a dataset:",
    ...
    CONCEPT_SET_DELETE_DIALOG__NAME: "Name",
    CONCEPT_SET_DELETE_DIALOG__WARNING: "This action cannot be undone.",
    ...
    MANAGE_DASHBOARD_DIALOG__SAVE_ERROR: "Failed to update code for {0}",
    MANAGE_DASHBOARD_DIALOG__SAVE_SUCCESS: "Code saved successfully",
    MANAGE_DASHBOARD_DIALOG__START_VIEWER: "Start Viewer",
    MANAGE_DASHBOARD_DIALOG__STARTING_VIEWER: "Starting Viewer...",
    MANAGE_DASHBOARD_DIALOG__STOP_VIEWER: "Stop Viewer",
    MANAGE_DASHBOARD_DIALOG__STOPPING_VIEWER: "Stopping Viewer...",
    ...
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__SAVE_ERROR: "Failed to update code for {0}",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__SAVE_SUCCESS: "Code saved successfully",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__START_VIEWER: "Start Viewer",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__STARTING_VIEWER: "Starting Viewer...",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__STOP_VIEWER: "Stop Viewer",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__STOPPING_VIEWER: "Stopping Viewer...",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__OPEN_VIEWER: "Open Viewer",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__VIEWER_STATUS: "Viewer Status: {0}",
    MANAGE_STRATEGUS_RESULT_VIEWER_DIALOG__SELECT_DATASET: "Select Dataset",
    ...
    STUDY_OVERVIEW__ANALYSIS_ID: "Analysis ID",
    STUDY_OVERVIEW__MODE: "Mode",
    STUDY_OVERVIEW__NOTEBOOK_NAME: "Notebook Name",
    ...
    STUDY_CARD__STOP_VIEWER: "Stop viewer",
    STUDY_CARD__STARTING_VIEWER: "Starting viewer...",
    STUDY_CARD__STOPPING_VIEWER: "Stopping viewer...",
    ...
    STUDY_CARD__SUCCESS_VIEWER_STOPPED: "Result viewer for {0} stopped successfully",
    ...
    STUDY_CARD__ERROR_STOP_VIEWER: "Failed to stop study viewer for {0}",
